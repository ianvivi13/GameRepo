    ...
    <body class="StaticBackground">
        ...
        function radioClicked(){
            ...
            case 'uno':
                ...
                <li>If a player gets rid of all cards, the game ends</li>
                <li><u>69 Gamemode:</u></li>
                <li>If numeric cards '6' and '9' are played sequencially, every player's hand will be shuffled together and distributed between players</li>
